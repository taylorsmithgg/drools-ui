...
helloAjaxApp.controller("myController", ['$scope',
	...
	$scope.compileDrl = function(){
		...
		var res = $http.post(url+'rest/drools/drlCompile', dataObj);
    ...
    $scope.fireDrl = function(){
        ...
        var res = $http.post(url+'rest/drools/drlFire', dataObj);
    ...
    $scope.saveDrl = function(){
            var res = $http.post(url+'rest/context');
    ...
    $scope.$on('$routeChangeSuccess', function() {
        ...
        var res = $http.get(url+'rest/context/'+$routeParams.id);
        ...
        */
         ...
         $scope.onSubmit = function () {
              ...
              for (var key in data) {
                  ...
                  var res = $http.post(url+'rest/facts/insert/' + key, msg);
